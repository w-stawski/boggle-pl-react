...
export default function Dice({
  ...
  return (
    <button
      ...
      className={`relative flex aspect-square items-center justify-center border-4 border-black text-4xl font-black uppercase cursor-pointer transition-all sm:text-5xl ${wasInvalid ? "animate-shake bg-red-500" : ""} ${
        isSelected
